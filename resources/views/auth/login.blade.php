...
@section('content')
<div class="container main-c " style=" opacity: 0.8">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="background-color:rgba(2, 47, 115, 0.437);color:white">
                    ...
                    <form method="POST" action="{{ route('login') }}" >
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="float: right;padding: 3%;padding-Right: 8%;padding-Left: 8%;margin-Top: 8%;border-Radius: 25px;color: rgb(8, 8, 8);border: none;opacity:0.9;color:white;background: linear-gradient( 45deg,#66a6db,#1e5fe0)">
                                  <b>  {{ __('Se Connecter') }}</b>
                                </button>
